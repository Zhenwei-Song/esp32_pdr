...
{
    CVect3 res1, res2;
    res1.i = v1.i > 0.0 ? v1.i : -v1.i;
    res2.i = v2.i > 0.0 ? v2.i : -v2.i;
    if (res1.i < res2.i)
        res1.i = res2.i;
    res1.j = v1.j > 0.0 ? v1.j : -v1.j;
    res2.j = v2.j > 0.0 ? v2.j : -v2.j;
    if (res1.j < res2.j)
        res1.j = res2.j;
    res1.k = v1.k > 0.0 ? v1.k : -v1.k;
    res2.k = v2.k > 0.0 ? v2.k : -v2.k;
    if (res1.k < res2.k)
        res1.k = res2.k;
    return res1;
}
...
CVect3 xyz2blh(const CVect3 &xyz)
{
    ...
    s3 = s3 * s3 * s3, c3 = c3 * c3 * c3;
    if (s < (6378137.0 * 1.0 * DEG))
        return O31;
...
CVect3 v2double(double f)
{
    ...
    f = (f - v.i) * 1.0e8;
    if (v.i > 50000000.0)
        v.i -= 100000000.0; // -45000000 ~ +45000000
    v.j = (int)(f + EPS);
    if (v.j > 50000000.0)
        v.j -= 100000000.0;
    v.k = 0.0;
...
CVect3 sort(const CVect3 &v)
{
    CVect3 vtmp = v;
    if (vtmp.i < vtmp.j)
        swapt(vtmp.i, vtmp.j, double);
    if (vtmp.i < vtmp.k)
        swapt(vtmp.i, vtmp.k, double);
    if (vtmp.j < vtmp.k)
        swapt(vtmp.j, vtmp.k, double);
    return vtmp;
}
...
{
    if (typ == 2)
        return CVect3(dm2r(v.i), dm2r(v.j), v.k);
...
{
    CVect3 res, mm;
    double *pf0 = &res.i, *pm = &mm.i;
    const double *pf1 = &p1.i, *pf2 = &p2.i, *pf3 = &p3.i;
    ...
    if (isMean) {
        if (mm.i < th.i)
            res.i = (p1.i + p2.i + p3.i) / 3.0;
        if (mm.j < th.j)
            res.j = (p1.j + p2.j + p3.j) / 3.0;
        if (mm.k < th.k)
            res.k = (p1.k + p2.k + p3.k) / 3.0;
    }
    return res;
}
...
{
    CVect3 dv = v - center;
    if (dv.i > th.i || dv.i < -th.i || dv.j > th.j || dv.j < -th.j || dv.k > th.k || dv.k < -th.k)
        return v;
...
CVect3 sv2att(const CVect3 &fb, double yaw0, const CVect3 &fn)
{
    ...
    CVect3 att = q2att(rv2q(phi * (nphi < 1.0e-10 ? 1.0 : afa / nphi)));
    att.k = yaw0;
...
CVect3 dv2att(const CVect3 &va1, const CVect3 &va2, const CVect3 &vb1, const CVect3 &vb2)
{
    ...
    if (IsZero(va1) || IsZero(a) || IsZero(aa) || IsZero(vb1) || IsZero(b) || IsZero(bb))
        return O31;
...
CVect3 mv2att(int n, const CVect3 *vai, const CVect3 *vbi, ...)
{
    ...
    va_list vl;
    va_start(vl, vai);
    vbi = va_arg(vl, CVect3 *);
    for (int i = 0; i < n; i++) {
        A += vxv(*vai, *vbi);
        vai = va_arg(vl, CVect3 *);
        vbi = va_arg(vl, CVect3 *);
    }
    va_end(vl);
...
CMat3 Rot(double angle, char axis)
{
    ...
    if (axis == 'x' || axis == 'X')
        return CMat3(1, 0, 0, 0, c, -s, 0, s, c);
    else if (axis == 'y' || axis == 'Y')
        return CMat3(c, 0, s, 0, 1, 0, -s, 0, c);
    else
        return CMat3(c, -s, 0, s, c, 0, 0, 0, 1);
}
...
CMat3 rcijk(const CMat3 &m, int ijk)
{
    ...
    case 021:
        return CMat3(m.e00, m.e02, m.e01, m.e20, m.e22, m.e21, m.e10, m.e12, m.e11);
        break;
    case 102:
        return CMat3(m.e11, m.e10, m.e12, m.e01, m.e00, m.e02, m.e21, m.e20, m.e22);
        break;
    case 120:
        return CMat3(m.e11, m.e12, m.e10, m.e21, m.e22, m.e20, m.e01, m.e02, m.e00);
        break;
    case 201:
        return CMat3(m.e22, m.e20, m.e21, m.e02, m.e00, m.e01, m.e12, m.e10, m.e11);
        break;
    case 210:
        return CMat3(m.e22, m.e21, m.e20, m.e12, m.e11, m.e10, m.e02, m.e01, m.e00);
        break;
    }
    return m;
}
...
CMat3 a2mat(const CVect3 &att)
{
    ...
    CMat3 Cnb;
    Cnb.e00 = cj * ck - si * sj * sk;
    Cnb.e01 = -ci * sk;
    Cnb.e02 = sj * ck + si * cj * sk;
    Cnb.e10 = cj * sk + si * sj * ck;
    Cnb.e11 = ci * ck;
    Cnb.e12 = sj * sk - si * cj * ck;
    Cnb.e20 = -ci * sj;
    Cnb.e21 = si;
    Cnb.e22 = ci * cj;
    return Cnb;
...
CMat3 ar2mat(const CVect3 &attr) // reversed Euler angles to DCM
{
    ...
    CMat3 Cnb;
    Cnb.e00 = cj * ck;
    Cnb.e01 = si * sj * ck - ci * sk;
    Cnb.e02 = ci * sj * ck + si * sk;
    Cnb.e10 = cj * sk;
    Cnb.e11 = si * sj * sk + ci * ck;
    Cnb.e12 = ci * sj * sk - si * ck;
    Cnb.e20 = -sj;
    Cnb.e21 = si * cj;
    Cnb.e22 = ci * cj;
    return Cnb;
...
static double maxrt4(double b, double c, double d) // max real root for x^4+bx^2+cx+d=0
{
    ...
    theta3 = acos(y) / 3;
    sAct3 = sA * cos(theta3);
    sAst3 = sA * sqrt3 * sin(theta3);
    y1 = D - 2 * sAct3;
    sy1 = y1 < 0.0 ? 0.0 : sqrt(y1);
    y2 = D + sAct3 + sAst3;
    sy2 = y2 < 0.0 ? 0.0 : sqrt(y2);
    y3 = D + sAct3 - sAst3;
    sy3 = y3 < 0.0 ? 0.0 : sqrt(y3);
    if (E < 0.0)
        sy1 = -sy1;
...
CMat3 sfoam(const CMat3 &B, int iter)
{
    ...
    // double detB = det(B), adjBp2 = trMMT(adjBp), B2 = trace(BBp), cnd,lambda, lambda2, kappa, zeta, Psi, dPsi, dlambda;
    double detB = det(B), adjBp2 = trMMT(adjBp), B2 = trace(BBp), cnd, lambda, lambda2, Psi, dPsi, dlambda;
    double kappa = 0;
    double zeta = 0;
    if (B2 < EPS || adjBp2 < EPS)
        return I33;                  // rank(B)<2
    ...
    for (int k = 1; k < iter; k++) {
        ...
        if (zeta < EPS)
            return I33; // singular value s2+s3=0
        Psi = (lambda2 - B2);
        Psi = Psi * Psi - 8.0 * lambda * detB - 4.0 * adjBp2;
        dPsi = 8.0 * zeta;
        dlambda = Psi / dPsi;
        lambda = lambda - dlambda;
        if (fabs(dlambda / lambda) < 1.0e-15)
            break;
    }
...
CMat::CMat(int row0, int clm0, double f)
{
    ...
    clm = clm0;
    rc = row * clm;
    for (double *pd = dd, *pEnd = &dd[rc]; pd < pEnd; pd++)
        *pd = f;
}
...
{
    for (double *p = dd, *pEnd = &dd[rc]; p < pEnd; p++)
        *p = 0.0;
}
...
CMat CMat::operator*(const CMat &m0) const
{
    ...
    double *p = mtmp.dd;
    const double *p1i = this->dd, *p2 = m0.dd;
    for (int i = 0; i < m; i++, p1i += k) {
        for (int j = 0; j < n; j++) {
            double f = 0.0;
            const double *p1is = p1i, *p1isEnd = &p1i[k], *p2sj = &p2[j];
...
double trace(const CMat &m)
{
    ...
    int row1 = m.row + 1;
    double s = 0.0;
    for (const double *p = m.dd, *pEnd = &m.dd[m.rc]; p < pEnd; p += row1)
        s += *p;
    return s;
}
...
CMat dotmul(const CMat &m1, const CMat &m2)
{
    ...
    double *p = res.dd;
    for (const double *p1 = m1.dd, *p2 = m2.dd, *pEnd = &m1.dd[m1.rc]; p1 < pEnd; p1++, p2++, p++) {
        *p = (*p1) * (*p2);
    }
    return res;
}
...
void CMat::SetMat3(int i, int j, const CMat3 &m, const CMat3 &m1)
{
    double *p = &dd[i * clm + j];
    *(CVect3 *)p = *(CVect3 *)&m.e00;
    *(CVect3 *)(p + 3) = *(CVect3 *)&m1.e00;
    p += clm;
    *(CVect3 *)p = *(CVect3 *)&m.e10;
    *(CVect3 *)(p + 3) = *(CVect3 *)&m1.e10;
    p += clm;
    *(CVect3 *)p = *(CVect3 *)&m.e20;
    *(CVect3 *)(p + 3) = *(CVect3 *)&m1.e20;
}
...
void CMat::SetMat3(int i, int j, const CMat3 &m, const CMat3 &m1, const CMat3 &m2)
{
    ...
    *(CVect3 *)p = *(CVect3 *)&m.e00;
    *(CVect3 *)(p + 3) = *(CVect3 *)&m1.e00;
    *(CVect3 *)(p + 6) = *(CVect3 *)&m2.e00;
    p += clm;
    *(CVect3 *)p = *(CVect3 *)&m.e10;
    *(CVect3 *)(p + 3) = *(CVect3 *)&m1.e10;
    *(CVect3 *)(p + 6) = *(CVect3 *)&m2.e10;
    p += clm;
    *(CVect3 *)p = *(CVect3 *)&m.e20;
    *(CVect3 *)(p + 3) = *(CVect3 *)&m1.e20;
    *(CVect3 *)(p + 6) = *(CVect3 *)&m2.e20;
}
...
CMat3 CMat::GetMat3(int i, int j) const
{
    ...
    CMat3 m;
    const double *p = &dd[i * clm + j];
    *(CVect3 *)&m.e00 = *(CVect3 *)p;
    p += clm;
    *(CVect3 *)&m.e10 = *(CVect3 *)p;
    p += clm;
...
CVect CMat::GetRow(int i) const
{
    ...
    for (double *p = v.dd; p1 < pEnd; p++, p1++)
        *p = *p1;
    return v;
}
...
CVect CMat::GetClm(int j) const
{
    ...
    for (double *p = v.dd; p1 < pEnd; p++, p1 += clm)
        *p = *p1;
    return v;
}
...
CMat CMat::GetClm(int j1, int j2, ...) const
{
    ...
    for (int i = 0; i < n; i++) {
        const double *p1 = &dd[j], *pEnd = &dd[rc];
        for (double *p = &m.dd[i]; p1 < pEnd; p += n, p1 += clm)
            *p = *p1;
        j = va_arg(vl, int);
    }
    va_end(vl);
...
{
    for (double *p = &dd[j], *pEnd = &dd[rc]; p < pEnd; p += clm)
        *p = 0.0;
    return;
}
...
CVect diag(const CMat &m)
{
    ...
    CVect vtmp(m.row, 1);
    double *p = vtmp.dd, *pEnd = &vtmp.dd[vtmp.row];
    for (const double *p1 = m.dd; p < pEnd; p++, p1 += row1)
        *p = *p1;
    return vtmp;
}
...
{
    CVect vtmp = v;
    for (double *p = &vtmp.dd[0], *pEnd = &vtmp.dd[vtmp.rc]; p < pEnd; p++)
        *p = -*p;
    return vtmp;
}
...
CMat CVect::operator*(const CVect &v) const
{
    ...
    else // (nxn) = (nx1)*(1xn)
    {
        ...
        for (const double *p1 = &dd[0], *p1End = &dd[rc], *p2End = &v.dd[rc]; p1 < p1End; p1++) {
            for (const double *p2 = &v.dd[0]; p2 < p2End; p2++)
                *p++ = *p1 * *p2;
        }
    }
    // stacksize();
...
CVect CVect::operator+(const CVect &v) const
{
    ...
    CVect vtmp(row, clm);
    for (double *p = vtmp.dd; p1 < p1End; p++, p1++, p2++) {
        *p = *p1 + *p2;
    }
    return vtmp;
}
...
CVect CVect::operator*(double f) const
{
    ...
    for (double *p = vtmp.dd; p1 < p1End; p++, p1++) {
        *p = *p1 * f;
    }
    // stacksize();
    return vtmp;
...
{
    for (double *p = dd, *pEnd = &dd[rc]; p < pEnd; p++, pf++) {
        *p = *pf;
    }
    return *this;
}
...
CVect &CVect::operator+=(const CVect &v)
{
    ...
    for (double *p = dd, *pEnd = &dd[rc]; p < pEnd; p++, p1++) {
        *p += *p1;
    }
    return *this;
}
...
double dot(const CVect &v1, const CVect &v2)
{
    ...
    double res = 0.0;
    for (const double *p1 = v1.dd, *p2 = v2.dd, *pEnd = &v1.dd[v1.rc]; p1 < pEnd; p1++, p2++) {
        res += (*p1) * (*p2);
    }
    return res;
}
...
CVect dotmul(const CVect &v1, const CVect &v2)
{
    ...
    double *p = res.dd;
    for (const double *p1 = v1.dd, *p2 = v2.dd, *pEnd = &v1.dd[v1.rc]; p1 < pEnd; p1++, p2++, p++) {
        *p = (*p1) * (*p2);
    }
    return res;
}
...
CVect abs(const CVect &v)
{
    ...
    for (double *p1 = res.dd; p < pEnd; p++, p1++) {
        *p1 = *p > 0 ? *p : -*p;
    }
    return res;
}
...
{
    for (double *p = &dd[i], *pEnd = &dd[mmin(j, MMD - 1)]; p <= pEnd; p++)
        *p = val;
}
...
{
    double m = 0.0;
    for (const double *p = v.dd, *pend = &v.dd[v.rc]; p < pend; p++)
        m += *p;
    return m / v.rc;
}
...
void CPolyfit::Init(double ts0, int n0, double spii)
{
    ...
    ts = ts0;
    tk = 0.0;
    n = n0 + 1; // polynomial highest order x^n0
    for (int i = 0; i < 5; i++) {
        Xk[i] = Kk[i] = 0.0;
        for (int j = 0; j < 5; j++)
            Pk[i][j] = 0.0;
               ...
               double *b2, double *a2, int n2)
{
    iir0 = CIIR(b0, a0, n0);
    if (n1 == 0)
        iir1 = iir0; // iir1 the same as iir0
    else
        iir1 = CIIR(b1, a1, n1);
    if (n2 == 0)
        iir2 = iir0; // iir2 the same as iir0
    else
        iir2 = CIIR(b2, a2, n2);
}
...
CRAvar::CRAvar(int nR0, int maxCount0)
{
    ...
    this->nR0 = nR0;
    for (int i = 0; i < RAMAX; i++) {
        Rmaxcount[i] = maxCount0, tau[i] = INF;
    }
}
...
double CVAR::Update(double data, BOOL isvar)
{
    ...
    if (++ipush == imax)
        ipush = 0;
    double *p0, *p1;
    for (mean = 0.0, p0 = &array[0], p1 = &array[imax]; p0 < p1; p0++)
        mean += *p0;
    mean /= imax;
    if (isvar) {
        for (var = 0.0, p0 = &array[0], p1 = &array[imax]; p0 < p1; p0++) {
            double vi = *p0 - mean;
            var += vi * vi;
        }
        var /= imax - 1;
...
CAbnomalCnt::CAbnomalCnt(int cntMax0, double tlast0, double valMax0, double valMin0)
{
    ...
    tlast = tlast0;
    valMax = valMax0;
    valMin = valMin0 < -INFp5 ? -valMax : valMin0;
    cnt = abnFlag = 0;
    t0 = 0.0;
}
...
{
    if (abnFlag && (++cnt > cntMax || (t - t0) > tlast))
        abnFlag = FALSE;
...
int CWzhold::Update(double wz) // wz in rad/s
{
    ...
    if ((tstop += ts) < 3.0) {
        ...
        if (big < 0) {
            ...
            meanw = meanwpre = meanwprepre = 0.0;
            Reset();
            retres = -5;
        }
        if (retres >= -2) {
            ...
            if (t > T) {
                ...
                if (meanwpre < -EPS || meanwpre > EPS) {
                    if (meanwprepre < -EPS || meanwprepre > EPS)
                        retres = 3;
                    else
                        retres = 2;
                }
...
int CMaxMin::Update(float f)
{
    ...
    if (--cntpreCur <= 0) {
        ...
        diffpreRes = maxpreRes - minpreRes;
        cntpreCur = cnt0;
        flag = -1;
    }
    return flag;
...
{
    mm[0].Update((float)v1.i);
    mm[1].Update((float)v1.j);
    mm[2].Update((float)v1.k);
    return flag = mm[0].flag;
}
...
int CMaxMinn::Update(const CVect3 &v1, const CVect3 &v2)
{
    ...
    mm[1].Update((float)v1.j);
    mm[2].Update((float)v1.k);
    mm[3].Update((float)v2.i);
    mm[4].Update((float)v2.j);
    mm[5].Update((float)v2.k);
    return flag = mm[0].flag;
}
...
int CMaxMinn::Update(const CVect3 &v1, const CVect3 &v2, const CVect3 &v3)
{
    ...
    mm[4].Update((float)v2.j);
    mm[5].Update((float)v2.k);
    mm[6].Update((float)v3.i);
    mm[7].Update((float)v3.j);
    mm[8].Update((float)v3.k);
    return flag = mm[0].flag;
}
...
int CMaxMinn::Update(const CVect3 &v1, const CVect3 &v2, const CVect3 &v3, const CVect3 &v4)
{
    ...
    mm[7].Update((float)v3.j);
    mm[8].Update((float)v3.k);
    mm[9].Update((float)v4.i);
    mm[10].Update((float)v4.j);
    mm[11].Update((float)v4.k);
    return flag = mm[0].flag;
}
...
int CMaxMinn::Update(const CVect3 &v1, const CVect3 &v2, const CVect3 &v3, const CVect3 &v4, const CVect3 &v5)
{
    ...
    mm[10].Update((float)v4.j);
    mm[11].Update((float)v4.k);
    mm[12].Update((float)v5.i);
    mm[13].Update((float)v5.j);
    mm[14].Update((float)v5.k);
    return flag = mm[0].flag;
}
...
{
    if (minmeanmaxFlag == -1)
        return mm[i].minRes; // min
    else if (minmeanmaxFlag == 0)
        return mm[i].meanRes; // mean
    else if (minmeanmaxFlag == 1)
        return mm[i].maxRes; // max
    else if (minmeanmaxFlag == 2)
        return mm[i].maxabsRes; // maxabs
    else
        return 0.0f;
}
...
CVect3 CMaxMinn::ResVect3(int i, int minmeanmaxFlag)
{
    ...
    if (minmeanmaxFlag == -1)
        return CVect3(pi0->minRes, pi1->minRes, pi2->minRes); // min
    else if (minmeanmaxFlag == 0)
        return CVect3(pi0->meanRes, pi1->meanRes, pi2->meanRes); // mean
    else if (minmeanmaxFlag == 1)
        return CVect3(pi0->maxRes, pi1->maxRes, pi2->maxRes); // max
    else if (minmeanmaxFlag == 2)
        return CVect3(pi0->maxabsRes, pi1->maxabsRes, pi2->maxabsRes); // maxabs
    else if (minmeanmaxFlag == 3)
        return CVect3(pi0->diffRes, pi1->diffRes, pi2->diffRes); // diffRes
    else
        return O31;
}
...
void CKalman::Init(int nq0, int nr0)
{
    ...
    Hk = CMat(nr, nq, 0.0);
    Fading = CMat(nr, nq, 1.0);
    zfdafa = 0.1f;
    Qt = Pmin = Xk = CVect(nq, 0.0);
    Xmax = Pmax = CVect(nq, INF);
    Pset = CVect(nq, -INF);
    Zk = Zk_1 = CVect(nr, 0.0);
    Rt = Rt0 = CVect(nr, INF);
    Rset = CVect(nr, -INF);
    rts = CVect(nr, 1.0);
    Zfd = CVect(nr, 0.0);
    Zfd0 = Zmm0 = Zmax = CVect(nr, INF);
    innoPre = CVect(nr, 0.0);
    innoDiffMax = CVect(nr, INF);
    RtTau = Rmax = CVect(nr, INF);
    measstop = measlost = Rmin = Rb = Rstop = CVect(nr, 0.0);
    Rbeta = CVect(nr, 1.0);
    SetRmaxcount(5);
    innoMax = CVect(nr, INF);
    SetInnoMaxcount(5);
    FBTau = FBMax = FBOne = FBOne1 = CVect(nq, INF);
    FBXk = FBTotal = CVect(nq, 0.0);
...
{
    for (int i = 0; i < nr; i++) {
        Rmaxcount[i] = 0, Rmaxcount0[i] = cnt;
    }
}
...
{
    for (int i = 0; i < nr; i++) {
        innoMaxcount[i] = 0, innoMaxcount0 = cnt;
    }
}
...
{
    SetZmm(0, 3, zmm0.i, cnt);
    SetZmm(1, 4, zmm0.j, cnt);
    SetZmm(2, 5, zmm0.k, cnt);
}

void CKalman::SetZmmPos(const CVect3 &zmm0, int cnt)
{
    SetZmm(3, 6, zmm0.i, cnt);
    SetZmm(4, 7, zmm0.j, cnt);
    SetZmm(5, 8, zmm0.k, cnt);
}
...
void CKalman::SetMeasMask(unsigned int mask, int type)
{
    int m;
    if (type == 1)
        measmask = mask; // set mask 1
    else if (type == 0)
        measmask &= ~mask; // delete mask to 0
    else if (type == 2)
        measmask |= mask; // add mask 1
...
void CKalman::SetMeasStop(unsigned int meas, double stop)
{
    for (int i = 0; i < measstop.rc; i++) { // assert(rc<32)
        if (meas & (0x01 << i) && (measstop.dd[i] < stop || stop <= 0.0))
            measstop.dd[i] = stop;
    }
...
void MeasUD(double U[], double D[], const double H[], double R, double K[], int n) // Ref: my book P291
{
    ...
    for (i = 0; i < n; i++) {
        for (f[i] = H[i], j = 0; j < i; j++)
            f[i] += H[j] * U[j * n + i]; // U: upper triangle
        g[i] = D[i] * f[i];
        afa += f[i] * g[i];
    }
    for (j = n - 1; j >= 0; j--) {
        ...
        for (i = j - 1; i >= 0; i--) {
            U[i * n + j] += lambda * g[i];
            for (s = i + 1; s < j; s++)
                U[i * n + j] += lambda * U[i * n + s] * g[s];
            DUHR[j] += H[i] * U[i * n + j]; // H*U = U^T*H^T
        }
        DUHR[j] *= D[j] / R;
    }
    for (i = 0; i < n; i++) {
        for (K[i] = DUHR[i], j = i + 1; j < n; j++)
            K[i] += U[i * n + j] * DUHR[j]; // K=U*D*U^T*H^T/R
    }
}
            ...
            if (*p > *pOne1 || *p < -*pOne1) { // max feedback/one step
                ...
                *pXk = *p * afa;
                if (*pXk > *pOne)
                    ...
                    *pXk = -*pOne; // min feedback/one step
            }
            if (*pMax < INFp5) {
                if (*pTotal + *pXk > *pMax)
                    *pXk = *pMax - *pTotal;
                else if (*pTotal + *pXk < -*pMax)
                    *pXk = -*pMax - *pTotal;
            }
            *p -= *pXk;
            *pTotal += *pXk;
...
void CSINSTDKF::Init(const CSINS &sins0)
{
    ...
    curOutStep = 0;
    maxOutStep = 1;
    timcnt0 = timcnt1 = 0, timcntmax = 100;
    burden = 0.0;
    cststt = nq;
    for (int k = 0; k < nq; k++)
        hi1[k] = -1;
...
{
    double hx = 0.0;
    for (double *ph = &Hk.dd[row * nq], *px = &Xk.dd[0], *pxEnd = &Xk.dd[Xk.rc]; px < pxEnd; ph++, px++) {
        hx += (*ph) * (*px);
    }
    return (Zk.dd[row] - hx);
}
...
int CSINSTDKF::TDUpdate(const CVect3 *pwm, const CVect3 *pvm, int nSamples, double ts, int nStep)
{
    ...
    if (++curOutStep >= maxOutStep) {
        RTOutput(), curOutStep = 0;
    }
    ...
    for (int j = 0; j < nr; j++) {
        ...
        if (Rstop.dd[j] > 0.0)
            Rstop.dd[j] -= sins.nts;
        if (measstop.dd[j] > 0.0)
            measstop.dd[j] -= sins.nts;
    }

    measRes = 0;

    if (nStep <= 0 || nStep >= maxStep) {
        nStep = maxStep;
    }
    tdStep = nStep;
    ...
    for (int i = 0; i < nStep; i++) {
        ...
        else if (iter == -1) // -1: discrete
        {
            ...
            double *pFk, *pFt, *pEnd;
            for (pFk = Fk.dd, pFt = Ft.dd, pEnd = &Fk.dd[cststt * Fk.clm]; pFk < pEnd; pFk++, pFt++)
                *pFk = *pFt * tdts;
            for (pFk = Fk.dd; pFk < pEnd; pFk += Fk.clm + 1)
                *pFk += 1.0;
            //			Xk = Fk*Xk;
            ...
            for (jj = 0; jj < cststt; jj++) {
                double f = 0.0;
                for (double *pX = Xk.dd; pX < pEnd; pFk++, pX++)
                    f += *pFk * *pX;
            ...
            if (flag) {
                ...
                if (iter % 2 == 0) {
                    ...
                    if (hi >= 0) {
                        Pk.GetClm(Pxz, hi);
                        Pz0 = Pxz.dd[hi];
                        innovation = Zk.dd[row] - Xk.dd[hi];
                        Zk_1.dd[row] = Zk.dd[row];
                    }
                    else {
#ifndef PSINS_FAST_CALCULATION
                        Pxz = Pk * (~Hi);
...
#endif
                        Pz0 = dot(Hi, Pxz);
                        innovation = Zk.dd[row] - dot(Hi, Xk);
                        Zk_1.dd[row] = Zk.dd[row];
                    }
                    double innoDiff = innovation - innoPre.dd[row];
                    innoPre.dd[row] = innovation;
                    int *pinnoMaxcount = &innoMaxcount[row];
                    if (*pinnoMaxcount > 0)
                        (*pinnoMaxcount)--;
                    if (innovation < -innoMax.dd[row] || innovation > innoMax.dd[row]) {
                        if (*pinnoMaxcount < 2 * innoMaxcount0)
                            *pinnoMaxcount += 2;
                    }
                    if ((*pinnoMaxcount == 0 || *pinnoMaxcount > innoMaxcount0) && (innovation > -Zmax.dd[row] && innovation < Zmax.dd[row]) && (innoDiff > -innoDiffMax.dd[row] && innoDiff < innoDiffMax.dd[row])) {
                        adptOKi = 1;
...
#endif
                        if (flag & 030)
                            Kk.dd[2] *= Kkp2y; // disable pos2yaw
                        else if (flag & 003)
                            Kk.dd[2] *= Kkv2y;
#ifndef PSINS_FAST_CALCULATION
                        Xk += Kk * innovation;
#else
                        for (double *pXk = Xk.dd, *pXkEnd = &Xk.dd[Xk.row], *pKk1 = Kk.dd; pXk < pXkEnd; pXk++, pKk1++)
                            *pXk += *pKk1 * innovation;
#endif
                        measlost.dd[row] = 0.0;
                    }
...
void CSINSTDKF::SetYaw(double yaw, int statephi, int statedvn)
{
    ...
    sins.qnb = qnn * sins.qnb;
    sins.Cnb = q2mat(sins.qnb);
    sins.Cbn = ~sins.Cnb;
    sins.att = m2att(sins.Cnb);
    sins.vn = qnn * sins.vn;
...
void CSINSGNSS::Init(const CSINS &sins0, int grade)
{
    ...
    if (grade == 0) { // inertial grade
        ...
        Rmin = Rt * 0.01;
        Rb = 0.6f;
        innoMax.Set(fXXX(1.0), fdPOS(30.0));
        SetInnoMaxcount(5);
...
void CSINSGNSS::SetFt(int nnq)
{
    ...
    // NULL; // 18 dt
        ...
        CMat3 Cwx, Cwy, Cwz;
        MMULf(Cwx, sins.Cnb, wi);
        MMULf(Cwy, sins.Cnb, wj);
        MMULf(Cwz, sins.Cnb, wk);
#endif
...
#else
        CMat3 Cfx, Cfy, Cfz;
        MMULf(Cfx, sins.Cnb, sins.fb.i);
        MMULf(Cfy, sins.Cnb, sins.fb.j);
        MMULf(Cfz, sins.Cnb, sins.fb.k);
#endif
...
void CSINSGNSS::Feedback(int nnq, double fbts)
{
    ...
    for (int i = 0; i < avpi.avpinum; i++) {
        avpi.vni[i] -= *(CVect3 *)&FBXk.dd[3];
        avpi.posi[i] -= *(CVect3 *)&FBXk.dd[6];
    }
    sins.qnb -= *(CVect3 *)&FBXk.dd[0];
    sins.vn -= *(CVect3 *)&FBXk.dd[3];
    sins.pos -= *(CVect3 *)&FBXk.dd[6];
    sins.eb += *(CVect3 *)&FBXk.dd[9];
    sins.db += *(CVect3 *)&FBXk.dd[12]; // 0-14 phi,dvn,dpos,eb,db
    if (nnq == 16) {
...
void CSINSGNSS::LogXk(void)
{
    ...
    dpos.i *= sins.eth.RMh, dpos.j *= sins.eth.clRNh;
    ...
    if (nq == 20) {
        ...
        CVect3 dKGz = *(CVect3 *)&Xk.dd[19];
        dKGz.i *= 1 / glv.sec, dKGz.j *= 1 / glv.sec, dKGz.k *= 1 / glv.ppm;
...
{
    CSINSTDKF::Init(CSINS(0.0));
    sins.mvnT = 0.2;
    sins.isOpenloop = 1;
    sins.eth.Update(pos0);
    gn = g00 > 9.0 ? CVect3(0, 0, -g00) : sins.eth.gn;
    sins.eth.pgn = &gn;
    sins.imu.SetKga();
...
void CSysClbt::NextIter(void)
{
    ...
    if (iter == 1) {
        ...
        if (ka2ORpn == 1)
            Pk.SetMat3(27, 27, pow(diag(fdKa23(10)), 2));
    }
    else if (iter >= 2) {
        FBMax = FBTau = INF;
        Pk.SetDiag2(fPHI(1, 6), fdVEL(0.1), fDPH3(0.01), fUG3(100.0),
...
{
    CVect3 fa = sins.fb * sins.imu.Cba;
    CMat3 Cna = sins.Cnb * sins.imu.iTCba;
    ...
    Ft.SetMat3(0, 0, -askew(sins.eth.wnie));
    Ft.SetMat3(0, 6, -sins.Cnb);
    ...
    Ft.SetMat3(3, 30, sins.Cnb * sins.imu.SSy, sins.Cnb * sins.imu.SSz);
    Ft.SetClmVect3(3, 36, CwXf);

    CVect3 vi = sins.imu.Cba.GetClm(2);
    CVect3 vo = CVect3(vi.j, -vi.i, 0);
    normlize(&vo);
    CVect3 vp = vi * vo;
...
void CSysClbt::Feedback(int nnq, double fbts)
{
    ...
    sins.qnb -= *(CVect3 *)&FBXk.dd[0];
    sins.vn -= *(CVect3 *)&FBXk.dd[3];
    sins.imu.eb += *(CVect3 *)&FBXk.dd[6];
    sins.imu.db += *(CVect3 *)&FBXk.dd[9];
    CMat3 IdKG = I33 - (~(*(CMat3 *)&FBXk.dd[12]));
    sins.imu.Kg = IdKG * sins.imu.Kg; // dKG
    CMat3 IdKA(1.0 - FBXk.dd[21], 0.0, 0.0,
               -FBXk.dd[22], 1.0 - FBXk.dd[24], 0.0,
    ...
    if (sins.imu.pKa2)
        ...
        sins.imu.Kapn += *(CVect3 *)&FBXk.dd[27]; // dKapn
    sins.imu.lvy += *(CVect3 *)&FBXk.dd[30];
    sins.imu.lvz += *(CVect3 *)&FBXk.dd[33]; // Inner lever
    sins.imu.tGA += FBXk.dd[36];             // tGA
#else
    qdelphi(sins.qnb, *(CVect3 *)&FBXk.dd[0]);
    VSUBE(sins.vn, (*(CVect3 *)&FBXk.dd[3]));
    VADDE(sins.imu.eb, (*(CVect3 *)&FBXk.dd[6]));
    VADDE(sins.imu.db, (*(CVect3 *)&FBXk.dd[9]));
    KgMdf(sins.imu.Kg, &FBXk.dd[12], 0); // dKG
    KaMdf(sins.imu.Ka, &FBXk.dd[21], 0); // dKA
    if (sins.imu.pKa2) {
        VADDE(sins.imu.Ka2, (*(CVect3 *)&FBXk.dd[27]));
    } // dKa2
    else {
        VADDE(sins.imu.Kapn, (*(CVect3 *)&FBXk.dd[27]));
    } // dKapn
    VADDE(sins.imu.lvy, (*(CVect3 *)&FBXk.dd[30]));
    VADDE(sins.imu.lvz, (*(CVect3 *)&FBXk.dd[33])); // Inner lever
    sins.imu.tGA += FBXk.dd[36];                    // tGA
#endif
}
...
CPOS618::CPOS618(double ts, double smthSec, BOOL isdebug) : CSINSGNSS(19, 6, ts)
{
    ...
    if (isdebug) {
        fins = new CFileRdWt("insdebug.bin", 0);
        fkf = new CFileRdWt("kfdebug.bin", 0);
    }
...
BOOL CPOS618::Load(char *fname, double t0, double t1)
{
    ...
    for (iter = 0, pIG = (ImuGnssData *)pmemImuGnss->get(0); iter < records; iter++, pIG++) { // find first pos0
        if (!IsZero(pIG->posgnss.k)) {
            posgnss0 = pIG->posgnss;
            break;
        }
    }
    if (iter >= records)
...
void CPOS618::Init(double talign, const CVect3 &att0)
{
    ...
    if (&att0 == &O31) { // self-align
        ...
        for (double t = 0.0; t < talign; t += ts, pIG++)
            aln.Update(&pIG->wm, &pIG->vm, 1, ts);
        att = q2att(aln.qnb0);
    }
    // KF Init
    pIG = (ImuGnssData *)pmemImuGnss->get(0);
    ...
    Pk.SetDiag2(fPHI(60, 600), fXXX(0.1), fdPOS(1.0), fDPH3(0.1), fMG3(1.0), fXXX(0.1), 0.0);
    PmaxPminCheck();
...
{
    sins.eth.wie = -sins.eth.wie;
    sins.vn = -sins.vn;
    sins.vnL = -sins.vnL;
    sins.eb = -sins.eb;                   // reverse INS
    int idx[] = {3, 4, 5, 9, 10, 11, 18}; // reverse Xk
    for (int k = 0; k < (sizeof(idx) / sizeof(int)); k++)
        Xk.dd[idx[k]] = -Xk.dd[idx[k]];
    TDReset();
    avpi.Init(sins, kfts, 1);
    SetMeasStop(0xffffffff, 2.0);
    int idxp[] = {0, 1, 3, 4, 5, 6, 7, 8, 14}; // enlarge Pk
    Pset = diag(Pk);
    for (int p = 0; p < (sizeof(idxp) / sizeof(int)); p++)
        Pset.dd[idxp[p]] = 10.0 * Pset.dd[idxp[p]];
}
...
CSINSGNSSCNS::CSINSGNSSCNS(double ts) : CSINSGNSS(18, 9, ts)
{
    ...
    Hk.SetMat3(6, 0, I33);
    Hk(6, 6) = 1.0; // SINS/CNS: Hk(7,7)=-sins.eth.cl; Hk(8,7)=-sins.eth.sl; Hk.SetMat3(6,15,sins.Cnb);
    Cbs = I33;
    SetMeasMask(0777);
}
...
CSINSGNSSDR::CSINSGNSSDR(double ts) : CSINSGNSS(21, 13, ts)
{
    ...
    Hk(6, 2) = 0.0;
    Hk.SetMat3(6, 6, I33);
    Hk.SetMat3(6, 18, -I33 * 0); // SINS/DR-dpos
...
void CSINSGNSSDR::Init(const CSINS &sins0, int grade)
{
    ...
    sins.pos = sins.posL;
    sins.lever(lvOD);
    posDR = sins.posL, sins.posL = posDRL = sins0.pos;
    avpi.Init(sins, kfts);
...
CSINSGNSSOD::CSINSGNSSOD(int nq0, int nr0, double ts, int yawHkRow0) : CSINSGNSS(nq0, nr0, ts, yawHkRow0)
{
    ...
    lvOD = vnOD = O31;
    Kod2 = AOS = 0.0;
    ODKappa(CVect3(0, 1, 0));
    odmeasOK = badODCnt = IVniFirst = 0;
    afaIVni = 1.0;
}
...
CVect3 CSINSGNSSOD::ODKappa(const CVect3 &kpp)
{
    ...
    if (&kpp == &O31) { // get
        res = m2att(Cbo);
        res.j = Kod; // Kappa = [dPitch; Kod; dYaw]
    }
    else { // set
        Kod = kpp.j;
...
int CSINSGNSSOD::ODVelUpdate(double dS)
{
    ...
    if (odmeast >= odmeasT) { // take measurement every (odmeasT)(s)
        ...
        if (Kod2 > EPS) {
            double k2 = Kod2 / odmeast;
            IVno.i += k2 * IVno.i * IVno.i;
            IVno.j += k2 * IVno.j * IVno.j;
        } // 2nd nonlinear scale factor
        if (AOS > EPS) {
            IVno = rotz(IVno, -AOS * sins.web.k);
        } // Angle Of Slide correct
        odZk = IVni - IVno;
        odmeast = 0.0;
        //		return odmeasOK=1;
        ...
        IVno += dSn;
        IVni += sins.vn * sins.nts;
        Ifn += sins.fn * sins.nts;
        IMv += dS * sins.Cnb;
...
void CAutoDrive::NHCtest(void)
{
    if (IsZero(sins.wnb.k, 20 * DPS)) {
        ...
        CVect3 vo = Con * sins.vn;
        Hk.SetMat3(12, 0, Con * askew(-sins.vn), Con);
        Hk.SetAskew(12, 15, vo); // FuQW,2012
        *(CVect3 *)&Zk.dd[12] = vo;
        SetMeasFlag(050000);
    }
}
...
int CAutoDrive::Update(const CVect3 *pwm, const CVect3 *pvm, double dS, int nn, double ts, int nSteps)
{
    ...
    if (odmeasOK) {
        Hk.SetMat3(6, 0, odMphi, odMvn);
        Hk.SetMat3(6, 15, odMkappa);
    ...
    if (*gnssLost > 10 && *odLost > 10.0)
        ZUPTtest();
    ZIHRtest();
    if (*gnssLost > 10 && *odLost > 10 && *zuptLost > 10)
        NHCtest();
    return res;
}
...
CSGOClbt::CSGOClbt(double ts) : CSINSGNSSOD(27, 10, ts, 9)
{
    ...
    Hk.SetMat3(6, 3, I33); // 6-8: SINS/OD-dvn
    Hk(yawHkRow, 2) = 1.0;
    Hk(yawHkRow, 25) = -1.0; // 9: SINS/GNSS-dyaw
    SetMeasMask(01777);
}
...
int CSGOClbt::Update(const CVect3 *pwm, const CVect3 *pvm, double dS, int nn, double ts, int nSteps)
{
    ...
    if (odmeasOK) {
        Hk.SetMat3(6, 0, odMphi, odMvn);
        Hk.SetMat3(6, 18, odMkappa, odMlever); // lvOD
        *(CVect3 *)&Zk.dd[6] = odZk;           // SINS/OD-dvn
        SetMeasFlag(0700);
    }
    return res;
...
int CVAutoPOS::Update(const CVect3 *pwm, const CVect3 *pvm, double dS, int nn, double ts, int nSteps)
{
    int res = CSINSGNSSOD::Update(pwm, pvm, dS, nn, ts, nSteps);
    if (odmeasOK) {
        Hk.SetMat3(0, 0, odMphi, odMvn);
        Hk.SetMat3(0, 15, odMkappa);
...
{
    Xk = Phi * Xk;
    Xk.j += an * ts;                  // Xkk_1=Phi*Xk+[0;a*nts;0]
...
void CCAM::Update(double Zpk, double Zvk)
{
    ...
    if (!IsZero(Zpk)) {
        ...
        Pk = (I33 - CMat3(Kk, O31, O31, 0)) * Pk;
        symmetry(Pk); // vxv(Kk,Hpk)=CMat3(Kk,O31,O31,0)
    }
    if (!IsZero(Zvk)) {
...
void CCALLH::Update(const CSINS &sins, const CVect3 &posGPS, const CVect3 &vnGPS)
{
    ...
    lat.Phi.e01 = sins.eth.f_RMh * sins.nts;
    lat.Phi.e12 = sins.nts;
    lat.Update(an.j, sins.nts, posGPS.i, vnGPS.j);
    lon.Phi.e01 = sins.eth.f_clRNh * sins.nts;
    lon.Phi.e12 = sins.nts;
    lon.Update(an.i, sins.nts, posGPS.j, vnGPS.i);
    hgt.Phi.e01 = sins.nts;
    hgt.Phi.e12 = sins.nts;
...
{
    db = CVect3(lon.Xk.k, lat.Xk.k, hgt.Xk.k);
    Pdb = CVect3(lon.Pk.e22, lat.Pk.e22, hgt.Pk.e22);
    vn = CVect3(lon.Xk.j, lat.Xk.j, hgt.Xk.j);
    Pvn = CVect3(lon.Pk.e11, lat.Pk.e11, hgt.Pk.e11);
    pos = CVect3(lat.Xk.i, lon.Xk.i, hgt.Xk.i);
    Ppos = CVect3(lat.Pk.e00, lon.Pk.e00, hgt.Pk.e00);
}
...
CVect3 CGKP::GKPCore(const CVect3 &BL)
{
    ...
    x = lB + t / 2 * N * cBk[2] * lk[2] + t / 24 * N * cBk[4] * (5 - tk[2] + 9 * eta2 + 4 * eta4) * lk[4] + t / 720 * N * cBk[6] * (61 + 58 * tk[2] + tk[4] + 270 * eta2 - 330 * tk[2] * eta2) * lk[6] + t / 40320 * N * cBk[8] * (1385 - 3111 * tk[2] + 543 * tk[4] - tk[6]) * lk[8];
    y = N * cB * l + 1. / 6 * N * cBk[3] * (1 - tk[2] + eta2) * lk[3] + 1. / 120 * N * cBk[5] * (5 + 18 * tk[2] + tk[4] + 14 * eta2 - 58 * tk[2] * eta2) * lk[5] + 1. / 5040 * N * cBk[7] * (61 - 479 * tk[2] + 179 * tk[4] - tk[6]) * lk[7];
...
CVect3 CGKP::IGKPCore(const CVect3 &xy)
{
    ...
    B = Bf + tf / (2 * Nfk[2]) * (-1 - etaf2) * yk[2] + tf / (24 * Nfk[4]) * (5 - 3 * tfk[2] + 6 * etaf2 - 6 * tfk[2] * etaf2 - 3 * etaf4 - 9 * tfk[2] * etaf4) * yk[4] + tf / (720 * Nfk[6]) * (-61 - 90 * tfk[2] - 45 * tfk[4] - 107 * etaf2 + 162 * tfk[2] * etaf2 + 45 * tfk[4] * etaf2) * yk[6] + tf / (40320 * Nfk[8]) * (1385 + 3633 * tfk[2] + 4095 * tfk[4] + 1575 * tfk[6]) * yk[8];
    l = 1. / (Nf * cBf) * y + 1. / (6 * Nfk[3] * cBf) * (-1 - 2 * tfk[2] - etaf2) * yk[3] + 1. / (120 * Nfk[5] * cBf) * (5 - 28 * tfk[2] + 24 * tfk[4] * 6 * etaf2 + 8 * tfk[2] * etaf2) * yk[5] + 1. / (5040 * Nfk[7] * cBf) * (-61 - 662 * tfk[2] - 1320 * tfk[4] - 720 * tfk[6]) * yk[7];
...
CIMU::CIMU(void)
{
    ...
    Sfg = Sfa = One31;
    Kg = Ka = Cba = iTCba = I33;
    eb = db = lvx = lvy = lvz = Kapn = Ka2 = Q11 = Q12 = Q13 = Q21 = Q22 = Q23 = Q31 = Q32 = Q33 = O31;
    SSx = SSy = SSz = O33;
}
...
double CIMU::Update(const CVect3 *pwm, const CVect3 *pvm, int nSamples, double ts)
{
    ...
    CVect3 cm(0.0), sm(0.0), wm[6], vm[6], vmma(0.0);
    wmm = O31, vmm = O31;
    ...
    if (pSf) {
        for (i = 0; i < nSamples; i++) {
            wm[i] = dotdiv(wm[i], Sfg);
            vm[i] = dotdiv(vm[i], Sfa);
        }
    }
    if (pKa2 || pKapn) {
        for (i = 0; i < nSamples; i++) {
    ...
    if (plv) {
        if (preWb) {
            wb_1 = phim * _nts, preWb = false;
        }
        CVect3 wb = phim * _nts, dwb = (wb - wb_1) * _nts;
        wb_1 = wb;
        CMat3 W = askew(dwb) + pow(askew(wb), 2);
        CVect3 fL;
        if (pCba) {
            SSx = CMat3(Q11 * W, Q21 * W, Q31 * W);
            SSy = CMat3(Q12 * W, Q22 * W, Q32 * W);
            SSz = CMat3(Q13 * W, Q23 * W, Q33 * W);
    ...
    smmT += nts;
    if (prfu) {
        IMURFU(&wmm, &vmm, 1, prfu);
        IMURFU(&phim, &dvbm, 1, prfu);
        IMURFU(&swmm, &svmm, 1, prfu);
    }
    return tk;
}
...
#define MAX_PP (MAX_NN - 1.0)
    ...
    double *pfTotal = &fTotalGx;
    int *pdi = &diGx, *piTotal0 = &iTotalGx0, *piTotal = &iTotalGx;
    for (int i = 0; i < 6; i++, pfTotal++, pdi++, piTotal0++, piTotal++) {
        if (*pfTotal >= MAX_PP)
            *pfTotal -= 2.0 * MAX_NN;
        else if (*pfTotal <= -MAX_NN)
            *pfTotal += 2.0 * MAX_NN;
        *piTotal = (int)(*pfTotal);
        *pdi = *piTotal - *piTotal0;
        if (*pdi > 100000000)
            *pdi -= 2147483648;
        else if (*pdi < -100000000)
            *pdi += 2147483648;
        *piTotal0 = *piTotal;
    }
}
...
{
    CVect3 vn1 = pp2vn(pos1, pos0, ts, &eth);
    vn1 = vn0 + (vn1 - vn0) * 2;
...
{
    temp_v0_adjust[0] = vn0.i * V0_PROP;
    temp_v0_adjust[1] = vn0.j * V0_PROP;
    temp_v0_adjust[2] = vn0.k * V0_PROP;
    temp_v0 = CVect3(temp_v0_adjust[0], temp_v0_adjust[1], temp_v0_adjust[2]);

    tk = tk0;
    ts = nts = 1.0;
    dist = -EPS;
    velMax = 400.0;
    hgtMin = -RE * 0.01, hgtMax = -hgtMin;
    latMax = 85.0 * DEG;
    afabar = 0.1;
    qnb = qnb0;
    vn = vn0, pos = pos0;
...
void CSINS::Update(const CVect3 *pwm, const CVect3 *pvm, int nSamples, double ts)
{
    ...
    if (isMemsgrade) {
      ...
      // CVect3 vn1 = O31;
        ...
        AXbt(imu.phim, Kg, imu.phim, eb, -nts);
        AXbt(imu.dvbm, Ka, imu.dvbm, db, -nts);
        //		CVect3 vn01 = vn+an*nts2, pos01 = pos+eth.vn2dpos(vn01,nts2);
        CVect3 vn01, pos01, dpos;
        VADDf(vn01, vn, an, nts2);
        eth.vn2dpos(dpos, vn01, nts2);
        VADD(pos01, pos, dpos);
        if (!isOpenloop)
            eth.Update(pos01, vn01);
        //		wib = imu.phim*_nts; fb = imu.dvbm*_nts;
        VMULf(wib, imu.phim, _nts);
        VMULf(fb, imu.dvbm, _nts);
        //		web = wib - Cbn*eth.wnie;  webbar = (1-afabar)*webbar + afabar*web;
        CVect3 vtmp;
        mul(vtmp, Cbn, eth.wnie);
        VSUB(web, wib, vtmp);
        double b = 1 - afabar;
        VADDff(webbar, webbar, b, web, afabar);
        //		wnb = wib - Cbn*eth.wnin;
        mul(vtmp, Cbn, eth.wnin);
        VSUB(wnb, wib, vtmp);
        //		fn = qnb*fb;
        mul(fn, qnb, fb);
        ...
        CVect3 wnint, fnn;
        double tn = -nts2;
        VMULf(wnint, eth.wnin, tn);
        CQuat q;
        rv2q(q, wnint);
        mul(fnn, q, fn);
        VADD(an, fnn, eth.gcc);
        VADDff(anbar, anbar, b, an, afabar);
        //		CVect3 vn1 = vn + an*nts;
        CVect3 vn1;
        VADDf(vn1, vn, an, nts);
    ...
    if (mvnT > EPS) { // calculate max/min/mean-vn within mvnT
        if (mvnk == 0) {
            ...
            if (vn.i > mvnmax.i)
                mvnmax.i = vn.i;
            else if (vn.i < mvnmin.i)
                mvnmin.i = vn.i;
            if (vn.j > mvnmax.j)
                mvnmax.j = vn.j;
            else if (vn.j < mvnmin.j)
                mvnmin.j = vn.j;
            if (vn.k > mvnmax.k)
                mvnmax.k = vn.k;
            else if (vn.k < mvnmin.k)
                mvnmin.k = vn.k;
        }
        mvni += vn;
        mvnt += nts;
    ...
    deg = (int)(pos.j / DEG);
    temp_out_data[3] = deg;
    temp_out_data[4] = pos.j / DEG - deg;
    deg = (int)(pos.i / DEG);
    temp_out_data[5] = deg;
    temp_out_data[6] = pos.i / DEG - deg;
    temp_out_data[7] = pos.k;
...
void CDR::Update(const CVect3 &wm, double dS, double ts, const CVect3 &vm)
{
    ...
    if (vel > velMax || vel < velMin)
        vel = velPre; // if abnormal, keep last velocity
    CVect3 vnk = Cnb * (Cbo * CVect3(0, vel, 0));
    velPre = vel;
    eth.Update(pos, vnk);
...
CCNS::CCNS(void)
{
    SetdT();
    Setxyp(0.0, 0.0);
    TT = era = gmst = gast = eps = dpsi = deps = 0.0;
    CP = CN = CW = Cie = I33;
}
...
{
    xp *= glv.sec;
    yp *= glv.sec; // inputs xp,yp are in arcsec
    double xyp = xp - yp;
...
void CCNS::Equinox(double TT)
{
    ...
    dpsi = (-17.1996 * sin(Om) - 1.3187 * sin(2 * F - 2 * D + 2 * Om) - 0.2274 * sin(2 * F + 2 * Om) + 0.2062 * sin(2 * Om) + 0.1426 * sin(lp)) * glv.sec;
...
void CAVPInterp::Init(const CVect3 &att0, const CVect3 &vn0, const CVect3 &pos0, double ts, int num)
{
    ...
    ipush = 0;
    avpinum = num;
    for (int i = 0; i < AVPINUM; i++) {
        atti[i] = att0, vni[i] = vn0;
        posi[i] = pos0;
    }
...
int CAVPInterp::Interp(double tpast, int avp)
{
    ...
    if (tleft > 0.99 * ts) {
        ...
        if (avp & 0x1) {
            ...
            if (normInf(att - atti[k1]) > 10.0 * DEG)
                res = 0;
        }
        if (avp & 0x2) {
            vn = b * vni[k1] + a * vni[k2];
        }
        if (avp & 0x4) {
            pos = b * posi[k1] + a * posi[k2];
            if (fabs(pos.j - posi[k1].j) > 1.0 * DEG)
                res = 0;
        }
    }
    return res;
...
void CMahony::Update(const CVect3 &wm, const CVect3 &vm, double ts, const CVect3 &mag)
{
    ...
    Cnb = q2mat(qnb);
    tk += ts;
    if (exyzInt.i > ebMax.i)
        exyzInt.i = ebMax.i;
    else if (exyzInt.i < -ebMax.i)
        exyzInt.i = -ebMax.i;
    if (exyzInt.j > ebMax.j)
        exyzInt.j = ebMax.j;
    else if (exyzInt.j < -ebMax.j)
        exyzInt.j = -ebMax.j;
    if (exyzInt.k > ebMax.k)
        exyzInt.k = ebMax.k;
    else if (exyzInt.k < -ebMax.k)
        exyzInt.k = -ebMax.k;
}
...
void CQEAHRS::Update(const CVect3 &gyro, const CVect3 &acc, const CVect3 &mag, double ts)
{
    ...
    Ft.dd[7] = wx / 2, Ft.dd[8] = 0, Ft.dd[9] = wz / 2, Ft.dd[10] = -wy / 2, Ft.dd[11] = -q0 / 2, Ft.dd[12] = q3 / 2, Ft.dd[13] = -q2 / 2;
    Ft.dd[14] = wy / 2, Ft.dd[15] = -wz / 2, Ft.dd[16] = 0, Ft.dd[17] = wx / 2, Ft.dd[18] = -q3 / 2, Ft.dd[18] = -q0 / 2, Ft.dd[20] = q1 / 2;
    Ft.dd[21] = wz / 2, Ft.dd[22] = wy / 2, Ft.dd[23] = -wx / 2, Ft.dd[24] = 0, Ft.dd[25] = q2 / 2, Ft.dd[26] = -q1 / 2, Ft.dd[27] = -q0 / 2;
    // Hk
...
int CVGHook::Update(CVect3 &wm, CVect3 &vm, double ts)
{
    ...
    mhny.Update(wm, vm, ts);
    tk += ts;
    mhny.qnb.SetYaw(pkf->sins.att.k);
    CVect3 dan = mhny.Cnb * (vm - pkf->sins.db * ts);
    dan.k += pkf->sins.eth.gn.k * ts;
    vn = (1 - ts / 10) * vn + dan;
    ...
    *(CVect3 *)&pkf->rts.dd[kfidx] = meats;
    ...
    if (normInf(wm) > maxGyro * DPS * ts || normInf(dan) > maxAcc * G0 * ts)
        overwbt = maxOverwbt;
    if (overwbt > 0.0) {
        overwbt -= ts;
    ...
    if (pkf->sins.an.k > -2 * (G0 + 0.5) && pkf->sins.an.k < -2 * (G0 - 0.5) && RVG.R0[2] < 0.1) {
        pkf->sins.qnb = UpDown(pkf->sins.qnb);
        pkf->sins.vn.k = 0;
        return 3;
    }
    return 1;
...
char *timestr(int type, char *p)
{
    ...
    if (type == 0)
        strftime(p, 32, "%Y%m%d_%H%M%S", Time); // YYYYmmdd_HHMMSS
    else if (type == 1)
        strftime(p, 32, "%Y%m%d", Time); // YYYYmmdd
    else if (type == 2)
        strftime(p, 32, "%H%M%S", Time); // HHMMSS
    return p;
}
...
void CFileRdWt::Init(const char *fname0, int columns0)
{
    ...
    {
        if (dirOut[0] != 0 && findc == 0) {
            strcat(fname, dirOut);
        }
    }
    else // file read
    {
        if (dirIn[0] != 0 && findc == 0) {
            strcat(fname, dirIn);
        }
    }
    strcat(fname, fname0);
    ...
    else if (columns > 0) // txt file read
    {
        ...
        while (1) // skip txt-file comments
        {
            ...
            for (int i = 0; i < sizeof(line); i++) {
                ...
                if (c != ' ')
                    allSpace = 0;
                if (!(c == ' ' || c == ',' || c == ';' || c == ':' || c == '+' || c == '-' || c == '.' || c == '\t' || c == 'e' || c == 'E' || c == 'd' || c == 'D' || ('9' >= c && c >= '0')))
                    allDigital = 0;
            }
            if (!allSpace && allDigital)
                break;
        }
...
int CFileRdWt::load(int lines, BOOL txtDelComma)
{
    ...
    {
        if (lines > 1)
            fseek(rwf, (lines - 1) * (-columns) * sizeof(double), SEEK_CUR);
        fread(buff, -columns, sizeof(double), rwf);
        if (lines == 0)
            fseek(rwf, columns * sizeof(double), SEEK_CUR);
    }
    else // txt file read
    {
...
CFileList::CFileList(const char *listf, const char *listout, const char *firstf, const char *lastf)
{
    ...
    for (unsigned int i = 0; i < strlen(listf); i++) {
        if (listf[i] == '*') { // using asterisk wildcard to find files
            ...
            if (firstf && lastf == NULL) {
                lastf = firstf;
                firstf = listout;
                listout = "listout.txt";
            } // CFileList(const char *listf, const char *firstf, const char *lastf)
            int res = 0;
            if (firstf) {
                while (res == 0 && strcmp(file.name, firstf))
                    res = _findnext(handle, &file);
            }
            if (res == -1) {
                _findclose(handle);
                handle = -1;
    ...
    if (!handle)
        rwf = fopen(fname, "rt"); // using input txt-file to find files
...
char *CFileList::NextFile(void)
{
    ...
    printf("--- %s\t%d\n", fname, iNextFile);
    if (flistout)
        fprintf(flistout, "%s\t %d\n", fname, iNextFile); // output the founded files to a txt-file
    char subfix[32];
    if (iSubfix)
        sprintf(subfix, "%s", &fname[strlen(fname) - iSubfix - 4]);
    else
        sprintf(subfix, "%03d.bin", iNextFile);
    sprintf(fins, "ins%s", subfix);
    sprintf(fkff, "kff%s", subfix); // create some useful file names
    sprintf(fxxx, "xxx%s", subfix);
    sprintf(fyyy, "yyy%s", subfix);
    sprintf(fzzz, "zzz%s", subfix);
    return fname;
}
...
{
    if (f) {
        fprintf(f, "\t%.8e\t%.8e\t%.8e ", v.i, v.j, v.k);
        Flush(3);
    }
    return *this;
}
...
{
    if (f) {
        fprintf(f, "\t%.8e\t%.8e\t%.8e\t%.8e ", q.q0, q.q1, q.q2, q.q3);
        Flush(4);
    }
    return *this;
}
...
CFileLog &CFileLog::CArray(const char *varname, const double *var, int row, int clm, double scale, const char *comment)
{
    if (f) {
        if (clm == 1) {
            clm = row;
            row = 1;
        } // CArray(varname, var, clm)
        if (row == 1)
            fprintf(f, "double %s[%d] = {", varname, clm);
        else
            fprintf(f, "double %s[%d][%d] = {", varname, row, clm);
        if (comment)
            fprintf(f, "\t// %s\n", comment);
        else
            fprintf(f, "\n");
...
CFileCfg WriteCfg(const char *fname, const char *ext)
{
    char name[256];
    if (ext)
        fname = strcat(strcpy(name, fname), ext);
    CFileCfg cfg;
...
CVect CSmooth::Update(const double *p, double *pmean)
{
    ...
    mean = sum * (1.0 / irow);
    if (pmean)
        memcpy(pmean, mean.dd, mean.rc * sizeof(double));
    return mean;
}
...
CInterp::CInterp(const char *fname, int clm)
{
    ...
    long sz = f.filesize();
    this->row = sz / (clm * sizeof(double)) + 2;
    pmem = new CRMemory(row, clm * sizeof(double));
    fread(pmem->get(1), sz, 1, f.rwf);
    double *p = (double *)pmem->set(0, pmem->get(1));
    *p = mint = -INF;
    p = (double *)pmem->set(row - 1, pmem->get(row - 2));
    *p = maxt = INF;
    irow = 0;
}
...
double CInterp::Interp(double t, double *data)
{
    ...
    if (p0[0] < t) {
        p1 = p0 + clm;
        if (t <= p1[0])
            OK_t = 1; // p0[0] < t <= p1[0],  cur interval
        else if (p1[0] < t) {
            p0 = p1;
            p1 = p0 + clm;
            irow++;
            if (t <= p1[0])
                OK_t = 1; // p1[0] < t <= p2[0], next interval
        }
    }
    else if (t <= p0[0]) {
        p1 = p0;
        ...
        irow--;
        if (p0[0] < t)
            OK_t = 1; // p_1[0] < t <= p0[0], pre interval
    }
    if (!OK_t) {
        if (t <= mint)
            t = mint;
...
{
    BYTE *ptmp = (BYTE *)malloc(clmBytes);
    BYTE *p0 = p, *p1 = p0 + (rows - 1) * clmBytes, *p11 = p1;
    memcpy(ptmp, p0, clmBytes);
    while (1) {
        memcpy(p0, p1, clmBytes);
        p0 += clmBytes;
        if (p0 >= p1)
            break;
        memcpy(p1, p0, clmBytes);
        p1 -= clmBytes;
        if (p0 >= p1)
            break;
    }
...
CQuat CAligni0::Update(const CVect3 *pwm, const CVect3 *pvm, int nSamples, double ts, const CVect3 &vel)
{
    ...
    if (velAid > 0) {
        ...
        vel0 = vel;
        if (velAid == 1)
            vtmp1 += Ci0n * dv; // for GPS vn-aided
        else if (velAid == 2)
            vtmp -= qib0b * dv + imu.phim * vel; // for OD vb-aided
    }
...
void CAligni0fit::Init(const CVect3 &pos0)
{
    ...
    qib0b = qnb = qnbsb = CQuat(1.0);
    qn0i0 = ~m2qua(pos2Cen(CVect3(eth.pos.i, 0.0, 0.0)));
    double G = glv.g0 * eth.cl / glv.wie / glv.wie;
    pfit4.Init(0.0, 4);
    pfit4.SetP(100.0, 100.0, 100 * G, 100 * G, 100 * G);
    pfit4.inHk = 0;
}
...
int CAligntrkang::Update(const CVect3 *pwm, const CVect3 *pvm, int nSamples, double ts, const CVect3 &vnr, int nSteps)
{
    ...
    if (vel > 1.0e-3) {
        ...
        yaw = atan2(-vnr.i, vnr.j);
        dyaw = fabs(diffYaw(yaw, yawPre));
        if (velPre > vel0 && vel > vel0 && wz < wz0 && dyaw < dyaw0) { // yaw meas
            ...
            if (fabs(Zk.dd[3]) > 20 * DEG) { // yaw init
                ...
                SetYaw(yaw);
                sins.vn = vnr;
                Pset.dd[0] = Pset.dd[1] = pow2(10 * DEG);
                Pset.dd[2] = pow2(20 * DEG);
...
void CAligntf::Feedback(int nnq, double fbts)
{
    ...
    mu += *(CVect3 *)&FBXk.dd[6];
    sins.eb += *(CVect3 *)&FBXk.dd[9];
    sins.db += *(CVect3 *)&FBXk.dd[12]; // 0-14 phi,dvn,mu,eb,db
...
{
    uart = CUartPP(frameLen, head);
    uart.csflag = 0;
    pUart = &uart;
    ps = (PSINSBoard *)&uart.popbuf[0];
    hConsole = GetStdHandle(STD_OUTPUT_HANDLE);
    SetConsoleTitle("PSINS��������λ����������(by YGM@NWPU)");
...
void CConUart::dispUart(int itv)
{
    ...
    if (ps->gpsstat > 0.9)
        memcpy(&ps1, ps, sizeof(PSINSBoard));
    static int itv0 = 0;
    if (itv < 1)
        itv = 1;
    if (itv0++ % itv)
...
{
    COORD xy;
    xy.X = clm, xy.Y = row; // (x,y)=(0,0) is left-up corner
...
void CConUart::sendUart(void)
{
    ...
    if (c == 'l') {
        ...
        if (f) {
            ...
            sprintf(&cmdstr[1], "�����ļ�pbcommand.txt��ȡ����");
        }
    }
    else if (cmd[0] == 'l' && c == 's') {
        cmd[0] = 'L';
...
CVect randn(const CVect &mu, const CVect &sigma)
{
    ...
    for (double *p = &vtmp.dd[0]; pmu < pEnd; p++, pmu++, psigma++)
        *p = randn(*pmu, *psigma);
    return vtmp;
}
...
CMat3 randn(const CMat3 &mu, const double &sigma)
{
    ...
    for (double *p = &mtmp.e00; pmu <= pEnd; p++, pmu++)
        *p = randn(*pmu, sigma);
    return mtmp;
}
...
CMat randn(const CMat &mu, const double &sigma)
{
    ...
    for (double *p = &mtmp.dd[0]; pmu < pEnd; p++, pmu++)
        *p = randn(*pmu, sigma);
    return mtmp;
}
...
void add(CVect &res, const CVect &v1, const CVect &v2)
{
    ...
    for (double *p = res.dd; p1 < pEnd; p++, p1++, p2++)
        *p = *p1 + *p2;
}
...
void mul(CVect &res, const CVect &v, const double &f)
{
    ...
    for (double *p = res.dd; p1 < pEnd; p++, p1++)
        *p = *p1 * f;
}
...
void mul(CVect &res, const CMat &m, const CVect &v)
{
    ...
    double *p = res.dd, *pEnd = &res.dd[res.row];
    const double *p1ij = m.dd, *p2End = &v.dd[v.rc];
    for (; p < pEnd; p++) {
        double f = 0.0;
        const double *p2j = v.dd;
        for (; p2j < p2End; p1ij++, p2j++)
